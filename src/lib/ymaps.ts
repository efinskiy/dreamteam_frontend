import type {
    GenericPointFeature,
    LngLat,
} from '@yandex/ymaps3-types/common/types';

export const restPoints: GenericPointFeature<LngLat>[] = [
    {
        type: 'Feature',
        id: '1',
        properties: {
        ...
        geometry: {
            type: 'Point',
            coordinates: [37.625285, 55.769541],
        },
    },
    {
        type: 'Feature',
        ...
        geometry: {
            type: 'Point',
            coordinates: [30.363435, 59.941539],
        },
    },
    {
        type: 'Feature',
        id: '3',
        properties: {
            name: 'Self Edge Japanese',
            description: 'rest',
        },
        geometry: {
            type: 'Point',
            coordinates: [37.587007, 55.773711],
        },
    },
];
